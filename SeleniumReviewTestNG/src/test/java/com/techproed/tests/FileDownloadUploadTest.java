...
public class FileDownloadUploadTest extends TestBase {
    ...
    public void dosyaVarMi(){
        ...
        // C:\Users\isimsiz\IdeaProjects\SeleniumReviewTestNG\pom.xml
        boolean varMi = Files.exists(Paths.get("C:\\Users\\emreduman\\Desktop\\selenium\\selenium.txt"));
    ...
    public void dosyaUpload(){
        ...
        chooseFile.sendKeys("C:\\Users\\emreduman\\Desktop\\selenium\\selenium.txt");
    ...
    public void dosyaIndirme(){
        ...
        boolean varMi = Files.exists(Paths.get("C:/Users/emreduman/Downloads/Penguins.jpg"));
        Assert.assertTrue(varMi);
    }
}